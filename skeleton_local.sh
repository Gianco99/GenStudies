...
wget -O --no-check-certificate __sample___fragment___timeStamp__.py __url__
...
xrdcp Configuration/GenProduction/python/__sample_____timeStamp__/__sample_____timeStamp___histos.root root://eosuser.cern.ch///eos/user/g/gdecastr/genStuff/__sample__/__sample_____timeStamp___histos.root
