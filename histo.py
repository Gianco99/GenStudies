...
def main():
  ...
  h_j1pt_GEN = TH1F('j1pt_GEN', 'j1pt_GEN', 100, 0, 400)
  ...
  histo_array['h_GenIsolatedPhoton_eta'] = h_GenIsolatedPhoton_eta
  histo_array['h_GenIsolatedPhoton_mass'] = h_GenIsolatedPhoton_mass
  histo_array['h_GenIsolatedPhoton_phi'] = h_GenIsolatedPhoton_phi
  histo_array['h_GenIsolatedPhoton_pt'] = h_GenIsolatedPhoton_pt
...
#  for entry in range(0,treein.GetEntries()):
  ...
  for entry in range(0,treein.GetEntries()):
    ...
    IsoPhotons = []
    p4temp = TLorentzVector()
    if treein.nGenIsolatedPhoton>0:
      for iIsoPhoton in range(0, treein.nGenIsolatedPhoton):
        p4temp.SetPtEtaPhiM(treein.GenIsolatedPhoton_pt[iIsoPhoton],treein.GenIsolatedPhoton_eta[iIsoPhoton],treein.GenIsolatedPhoton_phi[iIsoPhoton],treein.GenIsolatedPhoton_mass[iIsoPhoton])
        IsoPhotons.append(extend_p4(p4temp.Clone(), [22]*treein.nGenIsolatedPhoton))
      IsoPhotons.sort(key=lambda x: x.p4_vector.Pt(), reverse=True)
      
    if len(treein.GenIsolatedPhoton_eta) > 0:
      histo_array['h_GenIsolatedPhoton_eta'].Fill(IsoPhotons[0].p4_vector.Eta(), weight)
      histo_array['h_GenIsolatedPhoton_mass'].Fill(IsoPhotons[0].p4_vector.M(), weight)
      histo_array['h_GenIsolatedPhoton_phi'].Fill(IsoPhotons[0].p4_vector.Phi(), weight)
      histo_array['h_GenIsolatedPhoton_pt'].Fill(IsoPhotons[0].p4_vector.Pt(), weight)
